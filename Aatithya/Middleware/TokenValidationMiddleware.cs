...
namespace Aatithya.Middleware
{
    public class TokenValidationMiddleware
    {
        ...
        {
            // Define the list of paths to exclude from token validation
            var excludedPaths = new List<string>
            {
                "/api/Login/LoginAuthentication",
                "/api/Service/GetAllServices",  // Add more paths as needed
                "/api/Service/GetServicesById",

                "/api/AboutUs/GetAllAboutUs",
                "/api/AboutUs/GetAboutUsById",
                ...
                "/api/RoleRights/GetAllRoleRights",
                "/api/RoleRights/GetRoleRightsById",
