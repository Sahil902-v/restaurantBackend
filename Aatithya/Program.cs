...
///=============Added Middleware for Dependency Injection From MIDAS_BusinessLogicLayer.Middleware
builder.Services.AddServices();

///=============Added AutoMapper for Registers AutoMapper to map objects between layers.
